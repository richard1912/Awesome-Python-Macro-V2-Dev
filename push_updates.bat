...
:: Awesome-Python-Macro-V2-Dev Update Pusher Script (Windows Version)
:: This script helps push updates to the develop branch of the Awesome-Python-Macro-V2-Dev repository

:: Main script starts here
echo Starting Awesome-Python-Macro-V2-Dev Update Process...
echo.

:: Check if we're in a git repository
if not exist ".git" (
    echo [ERROR] Not in a git repository. Please run this script from the Awesome-Python-Macro-V2-Dev project directory.
    pause
    exit /b 1
)
...
git remote set-url origin https://github.com/richard1912/Awesome-Python-Macro-V2-Dev.git
if errorlevel 1 (
...
echo [INFO] Repository: https://github.com/richard1912/Awesome-Python-Macro-V2-Dev.git
